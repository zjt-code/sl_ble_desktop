...
uint32_t PeripheralBase::get_characteristic_prop( BluetoothUUID service_uuid,
                                                          BluetoothUUID characteristic_uuid)
{

    GattCharacteristic gatt_characteristic = _fetch_characteristic(service_uuid, characteristic_uuid);

    return (uint32_t)gatt_characteristic.CharacteristicProperties();
